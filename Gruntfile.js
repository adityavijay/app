module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        sass: {//?
            build: {
                ...
                files: {
                    'build/styles/app.css': 'code/styles/scss/app.scss'//SCSS compilation
                }
            }
        },
        ...
        concat: {  //Concanetion for JS and CSS
            ...
            js: {
                src: [
                    'code/js/lazyload/jquery.lazyload.min.js',
                    'code/js/vendor/foundation/foundation.js',
                    'code/js/vendor/foundation/foundation.dropdown.js',
                    'code/js/vendor/foundation/foundation.reveal.js',
                    'code/js/vendor/foundation/responsive-tables.js',
                    'code/js/vendor/jquery.flexslider-min.js',
                    'code/js/isotope/isotope.pkgd.min.js',
                    'code/js/vendor/jquery-datepicker.min.js',
                    'code/js/app.js'
                ],
   ...
   // grunt.loadNpmTasks('grunt-grunticon');
	...
	grunt.registerTask('css', 'Compiles all of the scss (libsass) and copies the files to the live directory.', [  'sass', 'concat:css', 'cssmin']);

    grunt.registerTask('js', 'Compiles all of the js and copies the files to the live directory.', [ 'concat:js', 'uglify']);

    grunt.registerTask('validate:sass', ['scsslint']);

    grunt.registerTask('code', ['clean', 'sass','concat:css', 'autoprefixer','cssmin', 'concat:js', 'uglify', 'copy:distcss', 'copy:distjs']);
...
//This sort out the confusion, how we serialize process. Default parsing goes according to default grunt task calling
    ...
    grunt.registerTask('default', ['clean', 'sass','concat:css', 'autoprefixer','cssmin', 'concat:js', 'uglify']);
};